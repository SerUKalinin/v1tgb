...
public class LedgerReliabilityIntegrationTest
        extends com.tradingbot.BaseIntegrationTest {
    ...
    void shouldRebuildPositionFromTradeHistory() {
        ...
        /*
         * 1. Given:
         * серия сделок через OrderFilledEvent.
         */
        publishTrade(
                "T1",
                "BTCUSDT",
        ...
        /*
         * 2. When:
         * выполняем rebuild из Trade history.
         */
        rebuildService.rebuildAllPositions();

        /*
         * 3. Then:
         * проверяем восстановленную позицию.
         */
        Optional<PositionEntity> posOpt =
                positionRepository.findBySymbol("BTCUSDT");
    ...
    void shouldIgnoreDuplicateTradesByExchangeId() {
        ...
        /*
         * 1. Given:
         * сделка уже записана через событие.
         */
        publishTrade(
                "DUP_1",
                "ETHUSDT",
        ...
        /*
         * 2. When:
         * отправляем то же событие ещё раз.
         */
        publishTrade(
                "DUP_1",
                "ETHUSDT",
        ...
        /*
         * 3. Then:
         * второй Trade не должен появиться.
         */
        assertThat(tradeRepository.count())
                .isEqualTo(1);
    }
    ...
    private void publishTrade(
         ...
         * executionId
         *
         * executionId должен быть:
         * 1. persisted в OrderEntity
         * 2. передан в OrderFilledEvent
         */
        ...
        /*
         * Создаём persisted Order только один раз.
         */
